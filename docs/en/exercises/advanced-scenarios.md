# Advanced Exercise: Business Scenarios

You are given a role. Write the report that the department actually needs.

---

### Scenario 1 -- CEO Weekly Report

**Role:** You are a data analyst. The CEO has requested a weekly summary for the Monday morning meeting.
...
### Scenario 2 -- Merchandising Team Product Review
...
### Scenario 3 -- Marketing Campaign Targets

**Role:** You are a marketing team member. You are preparing a reactivation email campaign.
...
### Scenario 4 -- Finance Team Month-End Closing

**Role:** You are a finance team member. You are preparing the December 2024 month-end closing report.
...
### Scenario 5 -- Logistics Team Delivery Delay Report

**Role:** You are a logistics team member.
...
### Scenario 6 -- Procurement Team Purchase Order Suggestion
...
### Scenario 7 -- CS Team Escalation

**Role:** You are the CS (Customer Service) team lead.
...
### Scenario 8 -- Executive Annual KPI Dashboard
