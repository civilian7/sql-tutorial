...
??? success "정답"
    ...
    **실행 결과** (1행)
    ...
    | id | parent | notused | detail |
    |---|---|---|---|
    | 3 | 0 | 63 | SEARCH orders USING INDEX idx_orders_... |
...
??? success "정답"
    ...
    **실행 결과** (1행)
    ...
    | id | parent | notused | detail |
    |---|---|---|---|
    | 3 | 0 | 58 | SEARCH orders USING INDEX idx_orders_... |
...
??? success "정답"
    ...
    **실행 결과** (2행)
    ...
    | id | parent | notused | detail |
    |---|---|---|---|
    | 3 | 0 | 45 | SEARCH oi USING COVERING INDEX idx_or... |
    | 7 | 0 | 37 | SEARCH p USING INTEGER PRIMARY KEY (r... |
...
??? success "정답"
    ...
    **실행 결과** (2행)
    ...
    | id | parent | notused | detail |
    |---|---|---|---|
    | 4 | 0 | 88 | SEARCH product_views USING INDEX idx_... |
...
??? success "정답"
    ...
    **실행 결과** (4행)
    ...
    | 7 | 3 | 71 | SEARCH point_transactions USING INDEX... |
    | 28 | 3 | 0 | USE TEMP B-TREE FOR LAST TERM OF ORDE... |
    | 51 | 0 | 63 | SCAN (subquery-2) |
