...
**힌트 1:** 빈칸에는 grade 컬럼과 'VIP' 값을 비교하는 등호 조건이 들어갑니다
...
**힌트 1:** 빈칸에는 정렬 기준 컬럼과 내림차순 키워드(DESC)가 들어갑니다
...
**힌트 1:** LEFT JOIN 후 매칭되지 않은 행은 오른쪽 테이블 컬럼이 NULL. IS NULL로 확인
...
**힌트 1:** COALESCE(컬럼, 기본값) 함수는 NULL일 때 대체값을 반환합니다
