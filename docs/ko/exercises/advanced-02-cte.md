...
??? success "정답"
    ...
    **결과 예시:**
    ...
    |---|---|---|---|---|
    | 2024-12 | 145600000 | 890 | 105000000 | 평균 이상 |
    | 2024-11 | 132000000 | 810 | 105000000 | 평균 이상 |
    | 2024-03 | 112000000 | 680 | 105000000 | 평균 이상 |
    | ... | ... | ... | ... | ... |
...
??? success "정답"
    ...
    **결과 예시 (상위 3행):**
    ...
    |---|---|---|---|---|---|
    | MacBook Pro 16 M3 | 노트북 | 18 | 45200000 | 12 | 4.58 |
    | LG 울트라기어 27GP950 | 모니터 | 25 | 32100000 | 8 | 4.25 |
    | 삼성 Galaxy Book4 Pro | 노트북 | 15 | 28900000 | 6 | 4.33 |
...
??? success "정답"
    ...
    **결과 예시 (상위 5행):**
    ...
    |---|---|---|---|
    | 노트북 | 182500000 | 22.5 | 22.5 |
    | GPU | 135000000 | 16.7 | 39.2 |
    | 모니터 | 98700000 | 12.2 | 51.4 |
    | CPU | 78500000 | 9.7 | 61.1 |
    | SSD | 65000000 | 8.0 | 69.1 |
...
??? success "정답"
    ...
    **결과 예시 (일부):**
    ...
    |---|---|---|---|
    | 1 | 데스크탑/워크스테이션 | 0 | 0 |
    | 3 | 데스크탑/워크스테이션 > 데스크탑 PC | 1 | 1 |
    | 5 | 데스크탑/워크스테이션 > 데스크탑 PC > 게이밍 데스크탑 | 2 | 2 |
    | 2 | 노트북/태블릿 | 0 | 0 |
    | ... | ... | ... | ... |
...
??? success "정답"
    ...
    **결과 예시 (일부):**
    ...
    |---|---|---|---|---|---|
    | 1 | 김대표 | management | admin | 0 | 김대표 |
    | 3 | 박매니저 | sales | manager | 1 | 김대표 > 박매니저 |
    | 8 | 이직원 | sales | staff | 2 | 김대표 > 박매니저 > 이직원 |
    | ... | ... | ... | ... | ... | ... |
...
??? success "정답"
    ...
    **결과 예시:**
    ...
    |---|---|---|---|---|
    | 1 | 김대표 | management | admin | 29 |
    | 3 | 박매니저 | sales | manager | 8 |
    | 5 | 최매니저 | logistics | manager | 6 |
    | ... | ... | ... | ... | ... |
...
??? success "정답"
    ...
    **결과 예시:**
    ...
    |---|---|---|---|
    | 노트북/태블릿 | 45 | 285000000 | 520 |
    | 데스크탑/워크스테이션 | 38 | 210000000 | 480 |
    | 부품 | 92 | 195000000 | 1250 |
    | 주변기기 | 65 | 118000000 | 890 |
    | ... | ... | ... | ... |
...
??? success "정답"
    ...
    **결과 (12행):**
    ...
    |---|---|---|
    | 2024-01 | 580 | 98500000 |
    | 2024-02 | 520 | 87200000 |
    | ... | ... | ... |
    | 2024-12 | 890 | 145600000 |
