...
커서(Cursor)는 결과 집합을 한 행씩 순회하며 처리할 때 사용합니다. 대량 일괄 처리나 행별 조건 분기가 필요한 경우에 유용합니다.
...
| 점수 | 다음 단계 |
|:----:|----------|
| **9~10개** | 축하합니다! [연습 문제](../exercises/index.md)에 도전하세요 |
| **7~8개** | 틀린 문제 해설을 복습한 뒤 연습 문제로 |
| **절반 이하** | 이 강의를 다시 읽어보세요 |
| **3개 이하** | [강의 25: JSON](25-json.md)부터 다시 시작하세요 |
