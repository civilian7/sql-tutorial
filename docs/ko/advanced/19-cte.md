# 강의 19: 공통 테이블 식(Common Table Expressions, WITH)
...
| 점수 | 다음 단계 |
|:----:|----------|
| **9~10개** | [강의 20: EXISTS](20-exists.md)로 이동 |
| **7~8개** | 틀린 문제 해설을 복습한 뒤 다음 강의로 |
| **절반 이하** | 이 강의를 다시 읽어보세요 |
| **3개 이하** | [강의 18: 윈도우 함수](18-window.md)부터 다시 시작하세요 |
...
---
다음: [강의 20: EXISTS와 상관 서브쿼리](20-exists.md)
